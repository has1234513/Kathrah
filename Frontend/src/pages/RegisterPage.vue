  ...
  <div class="auth-page">
    ...
    <div class="auth-form-panel">
      ...
      <div class="auth-form-wrap">
        ...
        <p class="auth-subtitle">Enter your email and password below to create your account</p>
    ...
    <div class="auth-brand-panel">
      <div class="auth-brand-panel__inner">
        <!-- Hexagon logo placeholder — replace img src with your actual logo asset -->
        <div class="brand-logo">
          <svg viewBox="0 0 200 230" fill="none" xmlns="http://www.w3.org/2000/svg" class="hex-svg">
            ...
            <!-- decorative Arabic-inspired calligraphy shape -->
